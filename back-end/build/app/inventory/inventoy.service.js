...
exports.updateInventory =
    exports.updateManufacturersInventory =
    exports.checkInventoryLevel =
    exports.getInventory =
    exports.addProductToInventory =
...
const addProductToInventory = (productId) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
...
const getInventory = (userId) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            const userInventory = yield user_service_1.default.getInventory(
                userId
            );
            if (!userInventory)
...
const checkInventoryLevel = (user, products) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            for (const product of products) {
                ...
                if (
                    ...
                    const theProduct =
                        yield product_service_1.default.getProductById(
                            product.productId
                        );
                    if (theProduct) {
...
const updateManufacturersInventory = (userId, product) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (inventory) {
                yield user_service_1.default.updateInventory(
                    inventory,
                    user._id.toString()
                );
                return inventory_responces_1.inventoryResponses
                    .INVENTORY_UPDATED;
            }
        } catch (e) {
            throw e;
...
const updateInventory = (userId, products) =>
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            const user = yield user_service_1.default.getUserById(userId);
            let inventory = user.inventory;
